...
export const API_COINNEWS = 'https://api.mytokenapi.com/news/listbyentity'; //	单个coin资讯
export const PAGE_COIN = 'https://www.mytokencap.com/currency/'; //	coin页面
export const SUB_INDEX_MARKET = 'market_cap';
export const SUB_INDEX_HOT = 'hot_search';
export const SUB_INDEX_WATCH = 'watch';
